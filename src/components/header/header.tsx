...
const Header = () => {
  return (
    <header className="hidden w-full h-[4.4rem] bg-white lg:flex items-center justify-between rounded-lg px-[1.9rem] cursor-pointer">
    <div className="flex w-auto items-center justify-between gap-1">
      <SearchIcon />
      <input type="text" className="border-none outline-none" />
    </div>
  
    <div className="hidden md:flex w-auto items-center justify-between gap-2.5">
